...
const GENRE_REVIEW_PARTS = {
  'Drama': {
    openings: [
      '{DIRECTOR} shapes {TITLE} as a {GENRE_ADJ} study of character and consequence',
      'In {TITLE}, {DIRECTOR} builds drama from performance, conflict, and restraint',
      '{TITLE} gives {DIRECTOR} room to explore emotional pressure with a {GENRE_ADJ} touch',
      'With {TITLE}, {DIRECTOR} centers the drama in behavior, silence, and difficult choices'
    ],
    middles: [
      'with performances that carry the emotional weight of the story',
      'through character dynamics that give the conflict a lived-in texture',
      'while letting small gestures accumulate into dramatic force',
      'that treats emotional restraint as a source of tension',
      'with a careful attention to interior conflict',
      'through scenes that privilege character over plot mechanics'
    ],
    closings: [
      'A measured drama that trusts character and emotional consequence.',
      '{DIRECTOR} shows a clear command of dramatic tone.',
      'The result is a drama grounded in performance and restraint.',
      'A strong dramatic work shaped by emotional precision.'
    ]
  },
  'Comedy': {
    openings: [
      '{DIRECTOR} turns {TITLE} into a {GENRE_ADJ} comic study',
      'In {TITLE}, {DIRECTOR} builds comedy from timing, character, and escalation',
      '{TITLE} showcases {DIRECTOR}\'s feel for comic rhythm',
      'With {TITLE}, {DIRECTOR} finds humor in the pressure points of everyday behavior',
      '{DIRECTOR} approaches {TITLE} as a {GENRE_ADJ} exercise in comic tension',
      'In {TITLE}, director {DIRECTOR} shapes a comedy of awkward timing and controlled absurdity',
      '{TITLE} lets {DIRECTOR} work through a distinctly {GENRE_ADJ} comic premise',
      'Director {DIRECTOR} gives {TITLE} a comic pulse rooted in performance and situation'
    ],
    middles: [
      'with comic timing that gives the premise room to escalate',
      'through performances calibrated around awkward pauses and small reversals',
      'while letting the humor emerge from character rather than punchline mechanics',
      'that understands how discomfort can become comic momentum',
      'with a dry sense of timing that sharpens each exchange',
      'through situational humor that grows naturally from the setup',
      'while balancing deadpan restraint with carefully placed absurdity',
      'that keeps the comic premise focused without flattening its characters',
      'with observational humor grounded in recognizable social behavior',
      'through editing rhythms that support the jokes without overexplaining them',
      'while finding laughs in escalation, silence, and tonal precision',
      'that treats comedy as a matter of rhythm, pressure, and release'
    ],
    closings: [
      'A sharply handled comedy that understands the value of timing.',
      'The result is a comic short with a clear sense of rhythm and restraint.',
      '{DIRECTOR} shows a strong command of comedic tone.',
      'A funny, carefully shaped entry in contemporary comedy.',
      'This is comedy built from observation rather than noise.',
      'A confident comic work that knows when to hold back and when to push.',
      'The film marks {DIRECTOR} as a filmmaker with a real ear for comic behavior.',
      'A strong comedy that turns a simple premise into something sharply performed.'
    ]
  },
  'Documentary': {
    openings: [
      '{DIRECTOR} approaches {TITLE} as a {GENRE_ADJ} act of observation',
      'In {TITLE}, {DIRECTOR} builds documentary force through access, attention, and context',
      '{TITLE} finds {DIRECTOR} working in a {GENRE_ADJ} nonfiction mode',
      'With {TITLE}, {DIRECTOR} turns inquiry into a carefully observed documentary portrait'
    ],
    middles: [
      'with an observational eye that gives the subject room to breathe',
      'through nonfiction detail that grounds the film in lived experience',
      'while shaping its subject with patience and ethical attention',
      'that understands documentary tension as a matter of context and perspective',
      'with a clear sense of what the camera can reveal without overstatement',
      'through careful attention to testimony, environment, and implication'
    ],
    closings: [
      'A thoughtful documentary that respects both subject and viewer.',
      '{DIRECTOR} demonstrates a strong command of nonfiction storytelling.',
      'The result is a documentary with clarity, patience, and purpose.',
      'A compelling nonfiction work rooted in observation and context.'
    ]
  },
  'Horror': {
    openings: [
      '{DIRECTOR} turns {TITLE} into a {GENRE_ADJ} exercise in dread',
      'In {TITLE}, {DIRECTOR} builds horror through atmosphere, tension, and implication',
      '{TITLE} lets {DIRECTOR} work in a {GENRE_ADJ} register of unease',
      'With {TITLE}, {DIRECTOR} treats fear as a matter of pacing, mood, and control'
    ],
    middles: [
      'with dread that gathers through atmosphere rather than shock alone',
      'through images that keep tension suspended just beneath the surface',
      'while using silence and negative space to sharpen unease',
      'that understands horror as a rhythm of anticipation and release',
      'with a controlled sense of menace that gives each moment weight',
      'through visual restraint that makes the threat feel more pervasive'
    ],
    closings: [
      'A controlled horror work that knows how to sustain unease.',
      '{DIRECTOR} shows a strong instinct for atmosphere and dread.',
      'The result is horror built from mood, pressure, and restraint.',
      'A tense genre piece with a clear command of fear and pacing.'
    ]
  },
  'Sci-Fi': {
    openings: [
      '{DIRECTOR} uses {TITLE} as a {GENRE_ADJ} speculative framework',
      'In {TITLE}, {DIRECTOR} builds science fiction from concept, consequence, and atmosphere',
      '{TITLE} places {DIRECTOR} in a {GENRE_ADJ} mode of cinematic speculation',
      'With {TITLE}, {DIRECTOR} treats genre as a way to test ideas about the present'
    ],
    middles: [
      'with speculative details that make the central idea feel tangible',
      'through world-building that serves the concept rather than overwhelming it',
      'while using genre mechanics to sharpen its philosophical questions',
      'that understands science fiction as a space for pressure-testing human behavior',
      'with a concept-driven structure that keeps the stakes intellectually clear',
      'through a future-facing premise grounded in recognizable emotion'
    ],
    closings: [
      'A thoughtful science-fiction work with a clear conceptual spine.',
      '{DIRECTOR} shows a strong command of speculative storytelling.',
      'The result is sci-fi that values ideas as much as atmosphere.',
      'A compelling genre piece shaped by concept and consequence.'
    ]
  },
  'Thriller': {
    openings: [
      '{DIRECTOR} shapes {TITLE} as a {GENRE_ADJ} study in pressure',
      'In {TITLE}, {DIRECTOR} builds thriller mechanics through pacing, tension, and control',
      '{TITLE} gives {DIRECTOR} a framework for suspense and escalation',
      'With {TITLE}, {DIRECTOR} turns uncertainty into a source of narrative momentum'
    ],
    middles: [
      'with pacing that keeps the pressure steadily tightening',
      'through controlled escalation that gives each turn consequence',
      'while sustaining suspense without losing sight of character',
      'that treats tension as a product of timing and withheld information',
      'with a lean sense of narrative pressure',
      'through scenes structured around risk, delay, and discovery'
    ],
    closings: [
      'A taut thriller that understands suspense as structure.',
      '{DIRECTOR} shows a confident command of tension and pacing.',
      'The result is a thriller built on pressure, control, and escalation.',
      'A strong suspense piece with a clear sense of momentum.'
    ]
  },
  'Animation': {
    openings: [
      '{DIRECTOR} gives {TITLE} a {GENRE_ADJ} animated language',
      'In {TITLE}, {DIRECTOR} builds animation from movement, design, and visual rhythm',
      '{TITLE} showcases {DIRECTOR}\'s attention to animated form and texture',
      'With {TITLE}, {DIRECTOR} treats animation as a space for expressive visual invention'
    ],
    middles: [
      'with design choices that give the world a distinct visual identity',
      'through movement and texture that carry emotional meaning',
      'while using animated form to shape tone and rhythm',
      'that understands animation as more than illustration',
      'with visual craft that makes each frame feel intentionally composed',
      'through stylized detail that supports the film\'s emotional logic'
    ],
    closings: [
      'A carefully crafted animated work with a strong visual identity.',
      '{DIRECTOR} shows a clear command of animated form.',
      'The result is animation shaped by design, rhythm, and feeling.',
      'A visually expressive film that uses animation with real purpose.'
    ]
  },
  'Experimental': {
    openings: [
      '{DIRECTOR} approaches {TITLE} as a {GENRE_ADJ} investigation of form',
      'In {TITLE}, {DIRECTOR} foregrounds structure, rhythm, and perception',
      '{TITLE} places {DIRECTOR} firmly in a {GENRE_ADJ} experimental mode',
      'With {TITLE}, {DIRECTOR} treats cinema as a space for formal inquiry'
    ],
    middles: [
      'with structural choices that challenge ordinary narrative expectation',
      'through rhythm, repetition, and abstraction rather than conventional plot',
      'while using form itself as the central expressive material',
      'that asks viewers to attend to image, duration, and perception',
      'with a willingness to let texture and arrangement carry meaning',
      'through a form-conscious approach that privileges sensation and structure'
    ],
    closings: [
      'A rigorous experimental work that commits fully to its formal logic.',
      '{DIRECTOR} shows a clear investment in cinematic form.',
      'The result is an experimental film defined by structure and perception.',
      'A bold formal piece that treats cinema as inquiry.'
    ]
  }
};
...
function normalizeReviewText_(text) {
  var out = String(text || '')
    ...
    .replace(/\ba ([aeiou][a-z-]*)/gi, function(_, word) { return 'an ' + word; })
    .replace(/\s+([,.;:!?])/g, '$1')
    .replace(/([,.;:!?])([^\s])/g, '$1 $2')
    .replace(/\.\s*\./g, '.')
    .trim();
...
function addMiddleCandidate_(selected, usedText, usedLead, usedFirstWord, candidate, options) {
  if (!candidate || usedText[candidate]) return false;
  ...
  if (strict && lead !== 'other' && usedLead[lead]) return false;
  if (strict && firstWord && usedFirstWord[firstWord]) return false;
...
function pickMiddleSentences_(genre) {
  var selected = [];
  var usedText = {};
  var usedLead = {};
  var usedFirstWord = {};
  var attempts = 0;
  var genreParts = GENRE_REVIEW_PARTS[genre] || null;

  if (genreParts && Array.isArray(genreParts.middles)) {
    while (selected.length < 2 && attempts < 200) {
      attempts += 1;
      addMiddleCandidate_(selected, usedText, usedLead, usedFirstWord, randomChoice(genreParts.middles), { strict: true });
    }
  }
  attempts = 0;
  ...
  while (selected.length < 3 && attempts < 300) {
    attempts += 1;
    addMiddleCandidate_(selected, usedText, usedLead, usedFirstWord, randomChoice(MIDDLE_SENTENCES), { strict: true });
  }

  attempts = 0;
  while (selected.length < 3 && attempts < 300) {
    attempts += 1;
    addMiddleCandidate_(selected, usedText, usedLead, usedFirstWord, randomChoice(MIDDLE_SENTENCES), { strict: false });
  }
...
function generateReview(formData) {
  ...
  const genreParts = GENRE_REVIEW_PARTS[genre] || {};
  const opening = randomChoice(genreParts.openings || OPENING_SENTENCES);
  const middles = pickMiddleSentences_(genre);
  const closing = randomChoice(genreParts.closings || CLOSING_SENTENCES);
